namespace Parsifal.Math.Geometry
{
    ...
    /// </remarks>
    public struct Point2D : System.IEquatable<Point2D>
    {
        #region property
        /// <summary>
        /// 原点
        ...
        {
            return System.Math.Sqrt(System.Math.Pow(_x - point._x, 2) + System.Math.Pow(_y - point._y, 2));
        }
        /// <summary>
        /// 偏移
        /// </summary>
        ...
        public override int GetHashCode() => System.HashCode.Combine(_x, _y);
