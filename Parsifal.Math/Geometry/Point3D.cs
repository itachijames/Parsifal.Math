namespace Parsifal.Math.Geometry
{
    ...
    public struct Point3D : System.IEquatable<Point3D>
    {
        ...
        {
            return System.Math.Sqrt(System.Math.Pow(_x - point._x, 2) + System.Math.Pow(_y - point._y, 2) + System.Math.Pow(_z - point._z, 2));
        }
        /// <summary>
        /// 偏移
        /// </summary>
        ...
        public override string ToString() => $"({_x:F3}, {_y:F3}, {_z:F3})";
        /// <summary>
        /// 解构
        /// </summary>
        /// <param name="x"></param>
