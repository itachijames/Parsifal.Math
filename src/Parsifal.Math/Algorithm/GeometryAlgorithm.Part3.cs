...
namespace Parsifal.Math.Algorithm
{
    public partial class GeometryAlgorithm
    {
        ...
        public static (double, double, double, double) GetPolygonMBR(in Polygon polygon)
        {
        ...
        /// <returns>外包矩形(最小X,最大X,最小Y,最大Y)</returns>
        public static (double, double, double, double) GetPolygonMBR(in Point2D[] polygon)
        {
        ...
        /// <returns>外包矩形(最小X,最大X,最小Y,最大Y)</returns>
        public static (double, double, double, double) GetCircleMBR(in Circle circle)
        {
